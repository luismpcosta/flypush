...
import io.opensw.flypush.api.database.generated.Indexes;
...
public class EngineFlywaySchemaHistory extends TableImpl<FlywaySchemaHistoryRecord> {

    private static final long serialVersionUID = 1L;

    /**
     * The reference instance of <code>push.flyway_schema_history</code>
     */
    public static final EngineFlywaySchemaHistory ENGINE_FLYWAY_SCHEMA_HISTORY = new EngineFlywaySchemaHistory();
    ...
    /**
     * The column <code>push.flyway_schema_history.installed_rank</code>.
     */
    ...
    /**
     * The column <code>push.flyway_schema_history.version</code>.
     */
    ...
    /**
     * The column <code>push.flyway_schema_history.description</code>.
     */
    ...
    /**
     * The column <code>push.flyway_schema_history.type</code>.
     */
    ...
    /**
     * The column <code>push.flyway_schema_history.script</code>.
     */
    ...
    /**
     * The column <code>push.flyway_schema_history.checksum</code>.
     */
    ...
    /**
     * The column <code>push.flyway_schema_history.installed_by</code>.
     */
    ...
    /**
     * The column <code>push.flyway_schema_history.installed_on</code>.
     */
    ...
    /**
     * The column <code>push.flyway_schema_history.execution_time</code>.
     */
    ...
    /**
     * The column <code>push.flyway_schema_history.success</code>.
     */
    ...
    private EngineFlywaySchemaHistory(Name alias, Table<FlywaySchemaHistoryRecord> aliased) {
        this(alias, aliased, null);
    }

    private EngineFlywaySchemaHistory(Name alias, Table<FlywaySchemaHistoryRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.table());
    }

    /**
     * Create an aliased <code>push.flyway_schema_history</code> table reference
     */
    public EngineFlywaySchemaHistory(String alias) {
        this(DSL.name(alias), ENGINE_FLYWAY_SCHEMA_HISTORY);
    }

    /**
     * Create an aliased <code>push.flyway_schema_history</code> table reference
     */
    public EngineFlywaySchemaHistory(Name alias) {
        this(alias, ENGINE_FLYWAY_SCHEMA_HISTORY);
    }

    /**
     * Create a <code>push.flyway_schema_history</code> table reference
     */
    public EngineFlywaySchemaHistory() {
    ...
    @Override
    public EngineFlywaySchemaHistory as(String alias) {
        return new EngineFlywaySchemaHistory(DSL.name(alias), this);
    }

    @Override
    public EngineFlywaySchemaHistory as(Name alias) {
        return new EngineFlywaySchemaHistory(alias, this);
    }
     ...
     */
    @Override
    public EngineFlywaySchemaHistory rename(String name) {
        return new EngineFlywaySchemaHistory(DSL.name(name), null);
    }
     ...
     */
    @Override
    public EngineFlywaySchemaHistory rename(Name name) {
        return new EngineFlywaySchemaHistory(name, null);
    }
